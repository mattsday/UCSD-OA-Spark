...
public class SparkMessageCreateTask extends AbstractTask {
	
	private static Logger logger = Logger.getLogger( SparkMessageCreateTask.class );

	@Override
	public void executeCustomAction(CustomActionTriggerContext context,
			CustomActionLogger actionLogger) throws Exception {
		SparkMessageCreateConfig config = (SparkMessageCreateConfig) context.loadConfigObject();
	...
	public TaskConfigIf getTaskConfigImplementation() {
		return new SparkMessageCreateConfig();
	}

	@Override
	public String getTaskName() {
		return SparkMessageCreateConfig.displayLabel;
	}
