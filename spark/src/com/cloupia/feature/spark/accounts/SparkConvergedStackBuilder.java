...
/**
 * SparkConvergedStackBuilder.java is the base class for providing account details in converged view.
 */
public class SparkConvergedStackBuilder implements ConvergedStackComponentBuilderIf {
	
	static Logger logger = Logger.getLogger(SparkConvergedStackBuilder.class);
		...
		public ConvergedStackComponentDetail buildConvergedStackComponent(
	        ...
	        SparkAccountJsonObject specificAcc = (SparkAccountJsonObject) JSON.jsonToJavaObject(json, SparkAccountJsonObject.class);
			...
			if( modelNames.size() > 0 )
				...
				detail.setModel("Spark");
			
			detail.setOsVersion("N/A");
		//	detail.setVendorLogoUrl("/app/uploads/openauto/SparkArrayIcon_150x75.png");
		...
		//	detail.setIconUrl("/app/uploads/openauto/SparkArrayIcon_150x75.png");
			//setting account context type
			detail.setContextType(ReportContextRegistry.getInstance().getContextByName(SparkConstants.INFRA_ACCOUNT_TYPE).getType());
